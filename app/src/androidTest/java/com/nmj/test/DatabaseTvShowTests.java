...
public class DatabaseTvShowTests extends InstrumentationTestCase {
    ...
    public void testCreateFilepathMapping() {
        ...
        DbAdapterTvShowEpisodeMappings dbMappings = NMJManagerApplication.getTvShowEpisodeMappingsDbAdapter();
    ...
    private void resetDatabase(DbAdapterTvShows db) {
        ...
        DbAdapterTvShowEpisodeMappings dbEpisodeMappings = NMJManagerApplication.getTvShowEpisodeMappingsDbAdapter();
