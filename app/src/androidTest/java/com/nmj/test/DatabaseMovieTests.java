...
public class DatabaseMovieTests extends InstrumentationTestCase {
    ...
    public void testDeleteAllMovies() {
        ...
        DbAdapterCollections dbCollections = NMJManagerApplication.getCollectionsAdapter();
        assertEquals(0, dbCollections.count());

        // Test filepath mapping count
        DbAdapterMovieMappings dbMovieMappings = NMJManagerApplication.getMovieMappingAdapter();
        assertEquals(0, dbMovieMappings.count());

        // There should be no files left to list in the movie thumbs folder
        assertEquals(0, NMJManagerApplication.getMovieThumbFolder(mContext).listFiles().length);

        // There should be no files left to list in the movie backdrops folder
        assertEquals(0, NMJManagerApplication.getMovieBackdropFolder(mContext).listFiles().length);
    }
    ...
    public void testMovieCollectionCreation() {
        ...
        assertEquals(true, NMJManagerApplication.getCollectionsAdapter().collectionExists("collectionId"));
    }
    ...
    public void testIgnoreMovie() {
        ...
        DbAdapterMovieMappings dbMappings = NMJManagerApplication.getMovieMappingAdapter();
    ...
    private DbAdapterMovies getAndResetDatabase() {
        ...
        // is required in order to use the NMJManagerApplication methods.
