...
public class ViewUtils {
    ...
    public static View setupActorCard(final Activity context, Picasso picasso, final Actor actor, final int toolbarColor) {
        ...
        // Load image
        picasso.load(actor.getUrl()).placeholder(R.color.card_background_dark).error(R.drawable.noactor).config(NMJManagerApplication.getBitmapConfig()).into(((ImageView) v.findViewById(R.id.cover)));
    ...
    public static View setupTvShowSeasonCard(final Activity context, Picasso picasso, final GridSeason season, final int toolbarColor) {
        ...
        picasso.load(season.getCover()).placeholder(R.color.card_background_dark).error(R.drawable.loading_image).config(
            NMJManagerApplication.getBitmapConfig()).into(((ImageView) v.findViewById(R.id.cover)));
    ...
    public static View setupPhotoCard(final Context context, Picasso picasso, final String url, final List<String> items, final int index, final int toolbarColor) {
        ...
        // Load image
        picasso.load(url).placeholder(R.color.card_background_dark).error(R.drawable.noactor).config(NMJManagerApplication.getBitmapConfig()).into(((ImageView) v.findViewById(R.id.cover)));
    ...
    public static int getNavigationDrawerWidth(Context context) {
        ...
        int toolbarHeight = NMJLib.getActionBarHeight(context);
        ...
        int maxWidth = NMJLib.convertDpToPixels(context, 5 * (NMJLib.isTablet(context) ? 64 : 56));
    ...
    public static void setProperToolbarSize(Context context, Toolbar toolbar) {
        toolbar.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                NMJLib.hasKitKat() ? NMJLib.getActionBarAndStatusBarHeight(context) : NMJLib.getActionBarHeight(context)));
    }
    ...
    public static void setLayoutParamsForDetailsEmptyView(Context context, View layout, ImageView background, ObservableScrollView scrollView, ViewTreeObserver.OnGlobalLayoutListener listener) {
        ...
        NMJLib.removeViewTreeObserver(scrollView.getViewTreeObserver(), listener);
    }
    ...
    public static void handleOnScrollChangedEvent(Activity activity, View layout, View background, String title, int height, int t, Toolbar toolbar, int toolbarColor) {
        final int headerHeight = (NMJLib.isPortrait(activity) ? background.getHeight() : layout.findViewById(R.id.empty_view).getHeight()) - height;
