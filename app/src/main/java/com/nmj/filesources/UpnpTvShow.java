...
public class UpnpTvShow extends TvShowFileSource<String> {
    ...
    public void removeUnidentifiedFiles() {
        ...
        for (int i = 0; i < count; i++) {
            if (dbEpisodes.get(i).isUpnpFile() && dbEpisodes.get(i).isUnidentified() && NMJLib.exists(dbEpisodes.get(i).getFilepath())) {
    ...
    public void removeUnavailableFiles() {
        ...
        for (int i = 0; i < dbEpisodes.size(); i++) {
            if (dbEpisodes.get(i).isUpnpFile() && !NMJLib.exists(dbEpisodes.get(i).getFilepath())) {
