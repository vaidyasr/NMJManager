...
public abstract class LibrarySectionAsyncTask<Params, Progress, Result> {
     ...
     *         {@link LibrarySectionAsyncTask.Status#RUNNING} or {@link LibrarySectionAsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final LibrarySectionAsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final LibrarySectionAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
		...
		final LibrarySectionAsyncTask mTask;
        final Data[] mData;

        @SuppressWarnings("rawtypes")
		AsyncTaskResult(LibrarySectionAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
