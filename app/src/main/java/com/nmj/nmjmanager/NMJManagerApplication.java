...
import static com.nmj.functions.PreferenceKeys.TV_SHOW_DATA_SOURCE;

public class NMJManagerApplication extends Application {
	...
	private static NMJAdapter sJSONMovies;
	...
	public static NMJAdapter getNMJAdapter() {
		return sJSONMovies;
	}
	...
	public static void setupTheme(Context context) {
		context.setTheme(R.style.NMJManager_Theme);
	}
