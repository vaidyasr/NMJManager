...
import com.nmj.nmjmanager.fragments.ActorPhotoFragment;
import com.nmj.utils.ViewUtils;
import com.squareup.otto.Bus;
import com.squareup.otto.Subscribe;

public class ImageViewer extends NMJActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (NMJLib.hasKitKat()) {
            setTheme(R.style.NMJManager_Theme_Translucent_FullScreen);
        } else {
            setTheme(R.style.NMJManager_Theme_Transparent_FullScreen);
        }
        ...
        mViewPager.setPageMargin(NMJLib.convertDpToPixels(getApplicationContext(), 16));
