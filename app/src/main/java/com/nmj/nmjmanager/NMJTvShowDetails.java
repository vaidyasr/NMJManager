...
import com.nmj.nmjmanager.fragments.NMJTvShowDetailsFragment;
import com.nmj.utils.ViewUtils;

public class NMJTvShowDetails extends NMJActivity {

    private static String TAG = "NMJTvShowDetailsFragment";
    private String mShowId, mMovieId;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (frag == null) {
            ...
            ft.add(android.R.id.content, NMJTvShowDetailsFragment.newInstance(mMovieId, mShowId), TAG);
            ft.commit();
        }
    }
