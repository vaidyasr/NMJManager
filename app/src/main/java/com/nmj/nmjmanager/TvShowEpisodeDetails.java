...
import com.nmj.nmjmanager.fragments.TvShowEpisodeDetailsFragment;
...
public class TvShowEpisodeDetails extends NMJActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mShowTitle = NMJManagerApplication.getTvDbAdapter().getShowTitle(mShowId);
        setTitle(mShowTitle);
		...
		if (savedInstanceState != null) {
			...
			for (int i = 0; i < mEpisodes.size(); i++) {
				if (mEpisodes.get(i).getSeason().equals(NMJLib.addIndexZero(mSeason)) && mEpisodes.get(i).getEpisode().equals(NMJLib.addIndexZero(mEpisode))) {
