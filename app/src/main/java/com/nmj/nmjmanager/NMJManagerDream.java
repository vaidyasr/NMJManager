...
@SuppressLint("NewApi")
public class NMJManagerDream extends DreamService implements ViewFactory {
	...
	public void onAttachedToWindow() {
		...
		mDatabaseHelper = NMJManagerApplication.getMovieAdapter();
		mDatabaseHelperTv = NMJManagerApplication.getTvDbAdapter();
