...
public class Welcome extends NMJActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!NMJLib.usesNavigationControl(getApplicationContext()))
    ...
    private void updateLibraryCounts() {
        mNumMovies = NMJManagerApplication.getMovieAdapter().count();
        mNumShows = NMJManagerApplication.getTvDbAdapter().count();
    ...
    private class WelcomeLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Cursor movieCursor = NMJManagerApplication.getMovieAdapter().getAllMovies();
            try {
            ...
            Cursor tvCursor = NMJManagerApplication.getTvDbAdapter().getAllShows();
            try {
