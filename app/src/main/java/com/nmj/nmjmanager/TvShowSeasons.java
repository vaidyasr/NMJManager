...
import com.nmj.nmjmanager.fragments.TvShowSeasonsFragment;
import com.nmj.utils.ViewUtils;

public class TvShowSeasons extends NMJActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int count = NMJManagerApplication.getTvEpisodeDbAdapter().getSeasonCount(mShowId);
