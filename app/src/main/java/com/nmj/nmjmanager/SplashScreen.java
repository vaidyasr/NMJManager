...
import com.nmj.service.MoveFilesService;
...
import static com.nmj.functions.PreferenceKeys.ROOT_ACCESS;
...
import static com.nmj.functions.PreferenceKeys.USE_ENGLISH_LANGUAGE;
...
public class SplashScreen extends Activity {
	...
	private boolean isDeviceCompatible() {
        return (getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_SIZE_MASK) != Configuration.SCREENLAYOUT_SIZE_SMALL && NMJLib.hasICSMR1();
    }
}