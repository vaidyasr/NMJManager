...
import com.nmj.nmjmanager.fragments.TvShowEpisodesFragment;
...
public class TvShowEpisodes extends NMJActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTitle = NMJManagerApplication.getTvDbAdapter().getShowTitle(mShowId);
