...
public class IgnoredTvShowFilesFragment extends Fragment {
    ...
    public class TvShowAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.folderName.setText(NMJLib.transformSmbPath(temp));
        ...
        public void notifyDataSetChanged() {
            ...
            Cursor cursor = NMJManagerApplication.getTvShowEpisodeMappingsDbAdapter().getAllIgnoredFilepaths();
            if (cursor != null)
                try {
    ...
    private void removeSelectedEpisode(String filepath) {
        NMJManagerApplication.getTvShowEpisodeMappingsDbAdapter().deleteFilepath(filepath);
