...
public class ActorDetailsFragment extends Fragment {
    ...
    private void fillViews() {
        ...
        mBirthday.setText(NMJLib.getPrettyDatePrecise(mContext, mActor.getBirthday()));
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        if (mMovieCards.getWidth() > 0) {
                            ...
                            NMJLib.removeViewTreeObserver(mMovieCards.getViewTreeObserver(), this);
                        }
                    }
                });
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        if (mTvCards.getWidth() > 0) {
                            ...
                            NMJLib.removeViewTreeObserver(mTvCards.getViewTreeObserver(), this);
                        }
                    }
                });
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        if (mPhotoCards.getWidth() > 0) {
                            ...
                            NMJLib.removeViewTreeObserver(mPhotoCards.getViewTreeObserver(), this);
                        }
                    }
                });
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        if (mTaggedPhotoCards.getWidth() > 0) {
                            ...
                            NMJLib.removeViewTreeObserver(mTaggedPhotoCards.getViewTreeObserver(), this);
                        }
                    }
                });
    ...
    private class ActorLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            for (int i = 0; i < mActor.getTvShows().size(); i++) {
                ...
                mActor.getTvShows().get(i).setInLibrary(NMJManagerApplication.getTvDbAdapter().showExists(id, title));
            }
